...
public sealed class ProductionBenchmarkCompilerExporter
{
    ...
    public async Task Export_Authoritative_Production_Generation_Requests()
    {
        ...
        var artifactsDir = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "scripts", "eval_artifacts", "v23"));
    ...
    public async Task ExportAuthoritativePR24PlanToJson()
    {
        ...
        var artifactsDir = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "scripts", "eval_artifacts", "pr24"));
        Directory.CreateDirectory(artifactsDir);
